...
Dim3AnalysisFactory::Dim3AnalysisFactory(const Dim3AnalysisContext & context)
...
TString format_hist_axes(const Dim3AnalysisContext & ctx)
{
...
// TString format_hist_caxes(const Dim3AnalysisContext & ctx)
// {
...
extern TString format_hist_xaxis(const Dim2AnalysisContext & ctx);
extern TString format_hist_yaxis(const Dim2AnalysisContext & ctx);

TString format_hist_zaxis(const Dim3AnalysisContext & ctx)
{
...
extern TString format_hist_Vaxis(const Dim3AnalysisContext & ctx);
...
void Dim3AnalysisFactory::prepareSigCanvas(bool flag_details)
{
...
TH2** Dim3AnalysisFactory::getSigsArray(size_t & size)
{
	size = 4;
