...
protected:
    void SetUp() override
    {
        ...
        ctx_2d = std::unique_ptr<midas::context>(
            new midas::context(ctx_3d->cast("ctx_2d", midas::dimension::DIM2)));
        ctx_1d = std::unique_ptr<midas::context>(
            new midas::context(ctx_2d->cast("ctx_1d", midas::dimension::DIM1)));
